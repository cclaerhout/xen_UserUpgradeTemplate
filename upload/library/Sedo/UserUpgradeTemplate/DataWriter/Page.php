...
class Sedo_UserUpgradeTemplate_DataWriter_Page extends XFCP_Sedo_UserUpgradeTemplate_DataWriter_Page
{
	protected function _getFields()
	{
		$fields = parent::_getFields();
		if(isset($fields['xf_page']))
		{
			$fields['xf_page']['sedo_template_name'] = array('type' => self::TYPE_BINARY, 'default' => '', 'maxLength' => 50);
		}
		return $fields;
	}
