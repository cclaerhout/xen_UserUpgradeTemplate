...
class Sedo_UserUpgradeTemplate_DataWriter_HelpPage extends XFCP_Sedo_UserUpgradeTemplate_DataWriter_HelpPage
{
	protected function _getFields()
	{
		$fields = parent::_getFields();
		if(isset($fields['xf_help_page']))
		{
			$fields['xf_help_page']['sedo_template_name'] = array('type' => self::TYPE_BINARY, 'default' => '', 'maxLength' => 50);
		}
		return $fields;
	}
